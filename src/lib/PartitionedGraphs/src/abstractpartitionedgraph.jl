...
using ..NamedGraphs: AbstractNamedGraph, NamedGraphs
using Graphs: Graphs, AbstractEdge, add_vertex!, dst, edgetype, has_vertex, is_directed,
    rem_vertex!, src, vertices
