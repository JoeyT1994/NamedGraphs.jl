...
using Graphs: add_edge!, add_vertex!, dst, edges, edgetype, has_edge, inneighbors,
    is_cyclic, is_directed, ne, nv, outneighbors, rem_edge!, src, vertices
...
using NamedGraphs.GraphsExtensions: TreeGraph, add_edge, add_edges, add_edges!, all_edges,
    arrange_edge, arranged_edges, child_edges, child_vertices, convert_vertextype, degrees,
    directed_graph, directed_graph_type, disjoint_union, distance_to_leaves, has_edges,
    ...
    root_vertex, subgraph, tree_graph_node, undirected_graph, undirected_graph_type,
